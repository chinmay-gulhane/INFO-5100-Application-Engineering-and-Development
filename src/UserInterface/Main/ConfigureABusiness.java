...
// Process Orders on behalf of sales person and customer
        ...
        Order order1 = masterorderlist.newOrder(customerprofile4, salespersonprofile1, customerprofile4.getMca());
        ...
        Order order12 = masterorderlist.newOrder(customerprofile3, salespersonprofile2, customerprofile3.getMca());
        ...
        Order order13 = masterorderlist.newOrder(customerprofile1, salespersonprofile, customerprofile1.getMca());
...
//===============================
        ...
        solutiontvteen.setTarget(1000);
        solutiontvteen.setFloor(500);
        solutiontvteen.setCeiling(1200);
        ...
        solutionwebteen.setTarget(500);
        solutionwebteen.setFloor(300);
        solutionwebteen.setCeiling(800);

        MasterSolutionOrderList msol = business.getMasterSolutionOrderList();

        SolutionOrder so = msol.newSolutionOrder(solutiontvteen, tvchannelteenmarket, customerprofile3, salespersonprofile4,800, 2);
        
        SolutionOrder so2 = msol.newSolutionOrder(solutionwebteen, webchannelteenmarket,customerprofile4, salespersonprofile, 300, 3);
        
        //System.out.println(msol.getRevenueByMarketChannelCombo(tvchannelteenmarket));
        //System.out.println(msol.getRevenueByChannel(webchannel));
        // solution 1:
        //for(SolutionOrder so: msol.get
